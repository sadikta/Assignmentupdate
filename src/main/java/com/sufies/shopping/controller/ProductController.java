...
public class ProductController {
    ...
    public String updateProduct(@RequestParam long id,ModelMap model){
        ...
        Long idprint = product.getpId();
        System.out.println("id printed in getmap"+idprint);
        model.put("product",product);
        return "updateproduct";
    }
    @PostMapping("/updateproduct")
    public  String updateProductSave(Product product){
        System.out.println("value"+product.getpId()+product.getPname()+product.getPcolor()+product.getPtype()+product.getPamount());
